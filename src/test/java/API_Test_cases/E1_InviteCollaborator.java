...
public class E1_InviteCollaborator 
{
  ...
  public void setBaseUri () 
  {
	  ...
	  reports = ExtentManager.GetExtent("http://34.214.158.70:32855/impp/imerit/collaborator/invite/0");
	  RestAssured.baseURI=PathUtility.BaseUrl+"imerit/collaborator/invite/0"; //ITEST API uri will start from 'imerit'
	  Log.startLogForThisCase("API Testing Resource collaborator/invite");
	  IOExcel.excelSetup(PathUtility.BaseFilepath+"E1_InviteCollaborator.xlsx");
